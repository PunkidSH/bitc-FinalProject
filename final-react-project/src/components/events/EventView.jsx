...
function EventView () {
  ...
  // 행사 마감 버튼 DB 정보에 따라 색상 다르게 출력(모집중 / 마감)
  // 모집중 버튼은 클릭하면 마감으로 글자 변경되고 비활성화됨, 마감여부 DB에 전달
  // 마감 조건 : 관리자가 직접 마감, 신청자 정원초과 자동 마감, 행사일 지나면 자동 마감 (Y, N 구분)
